...
export default function StoryPage() {
  ...
  useEffect(() => {
    if (story) {
      document.title = story.title || "Story Page";
      ...
      if (metaDescription) {
        metaDescription.content =
          ...
          "Read this amazing story on our platform!";
      } else {
      ...
      if (ogTitle) ogTitle.content = story.title;
        ...
        newOgTitle.content = story.title;
        document.head.appendChild(newOgTitle);
      }

      if (ogDescription) ogDescription.content = story.description;
      else {
        const newOgDescription = document.createElement("meta");
        newOgDescription.setAttribute("property", "og:description");
        newOgDescription.content = story.description;
        document.head.appendChild(newOgDescription);
      }

      if (ogImage) ogImage.content = story.media_url;
      else {
        const newOgImage = document.createElement("meta");
        newOgImage.setAttribute("property", "og:image");
        newOgImage.content = story.media_url;
